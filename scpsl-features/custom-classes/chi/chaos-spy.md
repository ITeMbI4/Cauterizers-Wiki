...
“Солист” прирождённый актёр, благодаря этому ему отлично получается проникать в ряды врага, даже не имея сильной “легенды”. Даже его близкие товарищи не знают его истинного лица, ведь никогда нельзя однозначно сказать, играет Солист или нет.\
...
> Протокол экспериментов с SCP-███. D-42502 был заражён SCP-███. Он был переведён в блок для содержания SCP-людей, а также отстранён от дальнейших экспериментов с целью исследования прогресса заражения.

> Сообщение адресовано оперативнику “Солист”: Этот D-42502 умер от какой-то херни. Мы не можем пока тебя эвакуировать, ведь тогда сразу раскроется что среди Сотрудников Класса-D был подставной. А пока мы не всё реализовали, что бы можно было раскрывать все карты.
